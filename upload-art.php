...
<body>
          ...
          <div class="upload-ur-art-container ">
            <div class="row">
              <div class="col-md-3 col-left-upld-imgs">
                ...
                <div class="bg-upload">
                    <h2>Image preview</h2>
                    <p class="m-0">This image will displayed on your product </p>
                  <div class="upload-col-left-img" id="imagePreview">
                    <!--<img  class="w-100"   alt="uploaded img">-->
                  </div>
                </div>
              </div>
                              ...
                              <div class="form-card">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-chk-box form-check-inline">
                                     <input class="" type="radio" name="installed_hardware" id="inlineRadio2" value="Yes">
                                    <label class="form-check-label" for="flexCheckChecked">
                                    Yes
                                    </label>
                                  </div>
                                  <div class="form-chk-box form-check-inline">
                                    <input class="" type="radio" name="installed_hardware" id="inlineRadio2" value="No">
                                    <label class="form-check-label" for="flexCheckChecked">
                                    No
                                    </label>
                                  </div>
                                ...
                                Yes
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="maaterial" placeholder="Material" /> 
                                  </div>
                                  <div class="col-md-6">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="styles" placeholder="Styles" /> 
                                  </div>
                                  <div class="col-md-6">
                               ...
                               <!-- Size section -->
                                <div class="row">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <input type="text" name="width" id="width" placeholder="Width (inches)" />
                                  </div>
                                  <div class="col-md-6">
                                    <label class="fieldlabels">Height</label>
                                    <input type="text" name="height" id="height" placeholder="Height (inches)" />
                                  </div>
                                </div>
                                 ...
                                 <div class="row">
                                    <div class="col-12 title-description">
                                      ...
                                      <input type="text" id="listInput" placeholder="Enter 6 - 10 keywords" maxlength="12" />
                                ...
                                <div class="row">
                                  <div class="col-12 title-description">
                                    ...
                                    <textarea id="w3review" name="review" rows="8" placeholder="Description" cols="50"></textarea>
                                  </div>
                                </div>
                              </div>
                              <input type="button" name="next" class="next action-button" value="Next" /> 
  ...
  <div class="row mb-2">
    ...
    <div class="col-3">
      <input type="text" id="inputPrice6" name="art_price" class="form-control m-0" placeholder="Enter Price" aria-describedby="passwordHelpInline">
    </div>
  </div>
